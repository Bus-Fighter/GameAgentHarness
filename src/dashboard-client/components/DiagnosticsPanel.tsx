...
export function DiagnosticsPanel({ status, mode }: DiagnosticsPanelProps) {
  ...
  return (
    <section className="card overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--surface)]">
      <div className="flex items-center gap-2 border-b border-[var(--border)] bg-[var(--surface-2)] px-4 py-3 text-sm font-semibold uppercase tracking-wider text-[var(--muted)]">
